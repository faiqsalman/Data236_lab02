...
// ── Review cards ─────────────────────────────────────────────────────────────
const ALL_REVIEWS = [
  { id: 1,  user: 'Sarah M.',  action: 'wrote a review',  time: 'Just now',       photo: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&q=80', business: 'The Golden Fork',    rating: 5, text: 'Absolutely incredible experience! The food was divine and the service was impeccable. I could not have asked for a better evening out.' },
  { id: 2,  user: 'James R.',  action: 'added a photo',   time: '2 minutes ago',  photo: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80', business: 'Burger Palace',      rating: 4, text: 'Best burger I have had in years. The patty was perfectly seasoned and the brioche bun was toasted to perfection. Will definitely return.' },
  { id: 3,  user: 'Mia L.',    action: 'wrote a review',  time: '15 minutes ago', photo: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400&q=80', business: 'Sakura Sushi Bar',  rating: 5, text: 'Fresh fish, beautiful presentation, and friendly staff. The omakase experience was worth every penny. One of the best in the city.' },
  { id: 4,  user: 'Tom B.',    action: 'wrote a review',  time: '1 hour ago',     photo: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&q=80', business: 'Blue Mug Cafe',     rating: 4, text: 'A hidden gem for coffee lovers. The single-origin pour over was smooth and complex. Cozy atmosphere perfect for working or catching up.' },
  { id: 5,  user: 'Lisa K.',   action: 'added 3 photos',  time: '2 hours ago',    photo: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=400&q=80', business: 'Taco Loco',         rating: 5, text: 'Authentic street-style tacos that transport you straight to Mexico City. The al pastor is a must-try. Great value and incredibly fast.' },
  { id: 6,  user: 'Mark D.',   action: 'wrote a review',  time: '3 hours ago',    photo: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=400&q=80', business: 'Luxe Hair Studio',  rating: 5, text: 'The stylist listened to exactly what I wanted and delivered beyond expectations. The salon is clean, modern, and the vibe is great.' },
  { id: 7,  user: 'Anna P.',   action: 'wrote a review',  time: '4 hours ago',    photo: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&q=80', business: 'Napoli Pizzeria',   rating: 4, text: 'Wood-fired pizza with a perfectly charred crust and fresh toppings. The Margherita is a classic done right. Bring cash — no cards.' },
  { id: 8,  user: 'Chris W.',  action: 'added a photo',   time: '5 hours ago',    photo: 'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&q=80', business: 'The Rooftop Bar',   rating: 4, text: 'Incredible views of the city skyline paired with creative cocktails. The bartenders know their craft and happy hour deals are unbeatable.' },
  { id: 9,  user: 'Nina F.',   action: 'wrote a review',  time: '6 hours ago',    photo: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&q=80', business: 'Iron Fitness Club', rating: 5, text: 'Top-notch equipment, clean facilities, and trainers who care about your progress. Signed up for a year after my very first week.' },
  { id: 10, user: 'Paul G.',   action: 'wrote a review',  time: '7 hours ago',    photo: 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&q=80', business: 'Sweet Scoops',      rating: 5, text: 'Over 40 flavors of homemade ice cream. The salted caramel and lavender honey are standouts. Generous portions and very fair prices.' },
  { id: 11, user: 'Rachel T.', action: 'added 2 photos',  time: '8 hours ago',    photo: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&q=80', business: 'The Morning Bun',  rating: 4, text: 'The pastries are baked fresh every morning and it shows. The almond croissant is flaky and buttery — pairs perfectly with their house blend.' },
  { id: 12, user: 'Owen C.',   action: 'wrote a review',  time: '10 hours ago',   photo: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&q=80', business: 'The Night Owl',    rating: 3, text: 'Good music and a lively atmosphere but the drinks are overpriced. Great spot for a night out if someone else is buying!' },
  { id: 13, user: 'Grace Y.',  action: 'wrote a review',  time: '12 hours ago',   photo: 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=400&q=80', business: 'Seoul Kitchen',    rating: 5, text: 'Authentic Korean BBQ with top-quality marinated meats. The banchan selection is generous and service is attentive without being intrusive.' },
  { id: 14, user: 'Ben H.',    action: 'added a photo',   time: '14 hours ago',   photo: 'https://images.unsplash.com/photo-1587899897387-091ebd01a6b2?w=400&q=80', business: 'Grease Monkey',    rating: 4, text: 'Fast, honest, and fairly priced. Diagnosed the issue in under 20 minutes and had my car ready the same day. Rare to find mechanics you trust.' },
  { id: 15, user: 'Chloe M.',  action: 'wrote a review',  time: '1 day ago',      photo: 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400&q=80', business: 'Serenity Spa',     rating: 5, text: 'The deep tissue massage was absolutely therapeutic. The space is calming, the staff is professional, and I left completely rejuvenated.' },
]
